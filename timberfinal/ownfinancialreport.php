...
<div class="header">
    ...
    <div class="tabs">
        ...
        <a class="active" href="ownreports.html">Reports</a>
    ...
    // Prepare the query
    $sql = "SELECT supplierpaymentis AS supplierpaymentid, compamount AS amount, comppaymentdate AS date FROM supplierpayments";
