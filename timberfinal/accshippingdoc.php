...
<body>
    ...
    $sql = "SELECT suppliershipmentid, shipmentdate, deliverystatus, deliverydate FROM suppliershipment";
    ...
    <div class="container">
        ...
        <div id="makepdf">
            ...
            <h2>Shipping Document</h2>
            <table id="shippingdocuments">
                <thead>
                    <tr>
                        <th>Shipment ID</th>
                        <th>Shipment Date</th>
    ...
    <script>
        ...
        button.addEventListener("click", function () {
            html2pdf()
                .from(makepdf)
                .save("shippingdocumentsreport.pdf");
        });
    </script>
</body>
</html>
