...
<html>
<head>
<title>PLACE ORDER | NEW SEDAWATTE TIMBER STORE</title>
...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['generateReport'])) {
        ...
        // Query to fetch all purchased items and the total price from finalordertotal
        ...
        if ($reportQuery->num_rows > 0) {
            ...
            // Add total price to the report if available
            $totalPrice = isset($reportData[0]['totalprice']) ? $reportData[0]['totalprice'] : 0;
            $message = "Report generated successfully!";
        } else {
            $reportData = null;
            $message = "No records found for the given Order ID.";
        }
    }
    ?>
    ...
    <div class="container">
        ...
        <form action="" method="POST">
            ...
            <div class="buttons">
                ...
                <button type="submit" name="goToPayment" onclick="window.location.href='cusmakepayment.html'">Go to Payment</button>
            </div>
        </form>
