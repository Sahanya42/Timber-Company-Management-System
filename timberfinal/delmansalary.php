...
<body>
    ...
    <div class="tabs">
        ...
        <a href="deliverymanagermain.html">Accountant</a>
        <a href="delmantask.php">Task</a>
        <a href="delmanattendance.php">Attendance</a>
        <a class="active" href="delmansalary.php">Salary</a>
    </div>

    <div class="container">
        <form action="delmansalaryfind.php" method="POST">
    ...
    $salary_query = "
        ...
        FROM salarytype
        WHERE salarytype IN ('Delivery Manager Basic', 'Delivery Manager Overtime', 'Delivery Manager Bonus')
    ";
    ...
    if ($result) {
        while ($row = mysqli_fetch_assoc($result)) {
            if ($row['salarytype'] == 'Delivery Manager Basic') {
                $basic = $row['salary'];
            } elseif ($row['salarytype'] == 'Delivery Manager Overtime') {
                $overtime_rate = $row['salary'];
            } elseif ($row['salarytype'] == 'Delivery Manager Bonus') {
                $bonus = $row['salary'];
            }
        }
    }
