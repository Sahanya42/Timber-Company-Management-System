...
<body>
    ...
    $salary_query = "
        ...
        FROM salarytype
        WHERE salarytype IN ('Employee Basic', 'Employee Overtime', 'Employee Bonus')
    ";
    ...
    if ($result) {
        while ($row = mysqli_fetch_assoc($result)) {
            if ($row['salarytype'] == 'Employee Basic') {
                $basic = $row['salary'];
            } elseif ($row['salarytype'] == 'Employee Overtime') {
                $overtime_rate = $row['salary'];
            } elseif ($row['salarytype'] == 'Employee Bonus') {
                $bonus = $row['salary'];
            }
        }
    }
