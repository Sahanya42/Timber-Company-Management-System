...
<body>
    ...
    <div class="tabs">
        ...
        <a href="accountantmain.html">Accountant</a>
        <a href="acctask.php">Task</a>
        <a href="accattendance.php">Attendance</a>
        <a class="active" href="accsalary.php">Salary</a>
    </div>

    <div class="container">
        <form action="accsalaryfind.php" method="POST">
    ...
    $salary_query = "
        ...
        FROM salarytype
        WHERE salarytype IN ('Accountant Basic', 'Accountant Overtime', 'Accountant Bonus')
    ";
    ...
    if ($result) {
        while ($row = mysqli_fetch_assoc($result)) {
            if ($row['salarytype'] == 'Accountant Basic') {
                $basic = $row['salary'];
            } elseif ($row['salarytype'] == 'Accountant Overtime') {
                $overtime_rate = $row['salary'];
            } elseif ($row['salarytype'] == 'Accountant Bonus') {
                $bonus = $row['salary'];
            }
        }
    }
