...
<head>
    <title>FINANCIAL REPORT | NEW SEDAWATTE TIMBER STORE</title>
...
<div class="header">
    ...
    <div class="tabs">
        ...
        <a class="active" href="accreportfinance.php">Create Report</a>
    ...
    // Prepare the query
    $sql = "SELECT supplierpaymentis, supplierid, compamount, comppaymentmethod, comppaymentdate FROM supplierpayments";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td align='right'>{$row['compamount']}</td>
    ...
    <script>
        ...
        button.addEventListener("click", function () {
            html2pdf()
                .from(makepdf)
                .save("companyfinancialreport.pdf");
        });
